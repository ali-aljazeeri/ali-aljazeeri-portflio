<template>
  <div>
    ...
    <Container class="min-h-screen flex flex-row flex-wrap">
      <!--work-->
      <div class="flex flex-col w-full md:w-1/2 mt-10">
        <h1 class="flex items-center font-bold">
          <!--general icon-->
          <span>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.0.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path
        ...
        <div class="flex mt-6 flex-1">
          ...
          <div class="flex flex-col">
            ...
            <div class="flex py-4" v-for="info in about.work">
              <!--black dot-->
              <div class="z-10 flex-shrink-0 mt-5 w-3 h-3 bg-black rounded-full"></div>
              <div class="ml-8">
      ...
      <div class="flex flex-col w-full md:w-1/2 mt-10">
        <h1 class="flex items-center font-bold">
          <!--general icon-->
          <span>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" viewBox="0 0 640 512"><!--! Font Awesome Pro 6.0.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path
